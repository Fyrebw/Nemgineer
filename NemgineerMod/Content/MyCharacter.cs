...
namespace NemgineerMod.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        ...
        public override string survivorTokenPrefix => NEMGINEER_PREFIX;

        public override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            bodyName = "NemgineerBody",
            bodyNameToken = NEMGINEER_PREFIX + "NAME",
            subtitleNameToken = NEMGINEER_PREFIX + "SUBTITLE",

            characterPortrait = Assets.mainAssetBundle.LoadAsset<Texture>("texNemgineerIcon"),
        ...
        public override ItemDisplaysBase itemDisplays => new NemgineerItemDisplays();
        ...
        public override void InitializeSkills()
        {
            ...
            string prefix = NemgineerPlugin.DEVELOPER_PREFIX;
            ...
            {
                skillName = prefix + "_NEMGINEER_BODY_SECONDARY_BLOCK_NAME",
                skillNameToken = prefix + "_NEMGINEER_BODY_SECONDARY_BLOCK_NAME",
                skillDescriptionToken = prefix + "_NEMGINEER_BODY_SECONDARY_BLOCK_DESCRIPTION",
            ...
            {
                skillName = prefix + "_NEMGINEER_BODY_UTILITY_EXPLOSIVEIDEAS_NAME",
            ...
            {
                skillName = prefix + "_NEMGINEER_BODY_SPECIAL_GEARUP_NAME",
                skillNameToken = prefix + "_NEMGINEER_BODY_SPECIAL_GEARUP_NAME",
                skillDescriptionToken = prefix + "_NEMGINEER_BODY_SPECIAL_GEARUP_DESCRIPTION",
        ...
        public override void InitializeSkins()
        {
            ...
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(NEMGINEER_PREFIX + "DEFAULT_SKIN_NAME",
