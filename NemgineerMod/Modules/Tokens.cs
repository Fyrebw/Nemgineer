...
namespace NemgineerMod.Modules
{
    internal static class Tokens
    {
        internal static void AddTokens()
        {
            ...
            desc = desc + "< ! > Pummel: Piercing, spear styled. Deal more damage in melee. Focus the healthier enemies since the weaker ones will die of piercing damage.200 % if it is a direct hit, 100 % for the piercing projectile. 0 sec cd.Proc coefficient: 1.25 for fists, 0.8 for projectiles damages." + Environment.NewLine + Environment.NewLine;
            ...
            #region Primary
            LanguageAPI.Add(prefix + "PRIMARY_SLASH_NAME", "Pummel");
