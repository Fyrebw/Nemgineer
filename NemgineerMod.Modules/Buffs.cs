...
namespace NemgineerMod.Modules
{
    internal static class Buffs
    {
        ...
        {
            Buffs.BlockBuff = Buffs.AddNewBuff("Heavyweight", Assets.MainAssetBundle.LoadAsset<Sprite>("texBuffBlock"), NemgineerModPlugin.characterColor, false, false);
            Buffs.energyShieldBuff = Buffs.AddNewBuff("EnergyShield", Assets.MainAssetBundle.LoadAsset<Sprite>("texBuffBlock"), NemgineerModPlugin.characterColor, false, false);
